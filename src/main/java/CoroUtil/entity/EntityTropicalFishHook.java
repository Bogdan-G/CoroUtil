...
public class EntityTropicalFishHook extends Entity implements IEntityAdditionalSpawnData {
   ...
   public void calculateVelocity(double var1, double var3, double var5, float var7, float var8) {
      ...
      this.prevRotationYaw = this.rotationYaw = ((float)Math.atan2(var1, var5) * 180.0F / 3.1415927410125732F);
      this.prevRotationPitch = this.rotationPitch = ((float)Math.atan2(var3, (double)var10) * 180.0F / 3.1415927410125732F);
   ...
   public void onUpdate() {
      ...
      if(this.field_6149_an > 0) {
         ...
         if(!this.inGround) {
            ...
            this.rotationYaw = ((float)Math.atan2(this.motionX, this.motionZ) * 180.0F / 3.1415927410125732F);

            for(this.rotationPitch = ((float)Math.atan2(this.motionY, (double)var24) * 180.0F / 3.1415927410125732F); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
               ;
            }
